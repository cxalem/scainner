...
export const metadata: Metadata = {
  title: "Sonda — Diagnostics you can actually read",
  description:
    "Read every fault your car reports, clear it, and understand what it actually means. OBD-II and UDS diagnostics for people who own the car.",
