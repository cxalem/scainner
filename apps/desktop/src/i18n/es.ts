...
export const es: Dictionary = {
  ...
  gate: {
    ...
    adapterTitle: "Elige un adaptador OBD",
    adapterHelp: "Selecciona una conexión serie disponible en macOS. Scainner identifica el lector ELM o STN al conectar.",
    refreshAdapters: "Actualizar",
    useAdapter: "Usar este adaptador",
    noAdapters: "Todavía no hay conexiones OBD serie disponibles.",
    pairedNeedsPort: "Está emparejado, pero macOS aún no ha creado una conexión serie.",
