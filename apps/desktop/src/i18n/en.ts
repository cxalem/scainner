...
export const en: Dictionary = {
  ride: {
    ...
    saved: {
      ...
      one: (minutes, sensors) => `Ride recorded. ${minutes} min, ${sensors} sensors, 1 fault code appeared.`,
  ...
  reportOffer: {
    ...
    rideTitle: "Your ride report",
    codeTitle: (code) => `Your report on ${code}`,
    ...
    cost: {
      ...
      plan: (left, total) => `Included in your plan, ${left} of ${total} left this month`,
    },
    primary: { price: (price) => `Get report · ${price}`, covered: "Get report", signedOut: "Sign in to continue" },
    notNow: "Not now",
  ...
  gate: {
    ...
    failure: {
      link: "Couldn't reach the dongle over Bluetooth.",
      open: "The adapter's port didn't open.",
      handshake: "The adapter didn't answer.",
      bus: "The car didn't answer.",
      unknown: "Couldn't connect.",
    },
    failureHints: {
      link: "Check it is plugged into the car and powered.",
      openBusy: "Another app may be using it, or the dongle needs a moment. Try again.",
      openTimeout: "The dongle didn't wake up in time. Try again.",
      handshake: "Unplug it, plug it back in, and try again.",
      bus: "Turn the ignition on and try again.",
    },
    failureDetails: "Details",
    chooseDeviceTitle: "Connect to your OBD device",
    lastUsed: "Last used",
    preparingAdapter: "Preparing…",
    pairedNotConnected: "Paired, not connected",
    transportBluetooth: "Bluetooth",
    transportUsb: "USB",
    refreshAdapters: "Refresh",
    lookingForDevices: "Looking for devices…",
    noDevices: "No devices found",
    pairFirst: "Plug the dongle in, then discover nearby devices.",
    devicesHeading: "Devices",
    discoverDevices: "Discover nearby devices",
    scanning: "Scanning for nearby devices…",
    scanningSeconds: (seconds) => `Scanning for nearby devices… ${seconds}s`,
    nearby: "Nearby",
    pair: "Pair",
    pairing: "Pairing…",
    pinRequired: "This dongle asked for a pairing code.",
    pinLabel: "PIN",
    pinHint: "Most OBD dongles use 1234 or 0000",
    noNearby: "No new devices nearby. Make sure the dongle is plugged in and in pairing mode.",
    ...
    pairedPortPending: "Paired. The port is not ready yet; try Refresh in a moment.",
    forget: "Forget",
    removeSavedAdapter: "Remove saved adapter",
    forgetTitle: (name) => `Forget ${name}?`,
    forgetDescription: "You'll need to pair it again to use it.",
    removeSavedTitle: (name) => `Remove ${name}?`,
    removeSavedDescription: (app) => `${app} will stop selecting it automatically.`,
    forgetConfirm: "Forget",
    removeConfirm: "Remove",
    cancelForget: "Cancel",
    forgot: (name) => `Forgot ${name}`,
    disconnectBeforeForget: "Disconnect before forgetting this device.",
