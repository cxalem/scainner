...
pub const ROUTES: &[RouteDoc] = &[
    ...
    r("POST", "/adapters/pair", "Pair one device the user chose, with the PIN they typed (most OBD dongles use 1234 or 0000). 200 {\"paired\": true}, or 400 with the platform's message. There is no unpair, and nothing re-pairs on its own", &[], Some(r#"{"addr": "aa-bb-cc-dd-ee-ff", "pin": "1234"}"#), false, false),
