...
Scainner is proprietary software. That does not change the licences of its
dependencies, research sources, fixtures, or knowledge overlays.

- The OBDb knowledge overlay is kept under CC BY-SA 4.0 with attribution and
  source details in
...
Before distributing a build or knowledge pack, generate and review a complete
dependency notice/SBOM for that release. This file is a policy boundary, not a
substitute for release-specific third-party notices.
